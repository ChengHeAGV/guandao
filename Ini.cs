...
namespace guandao
{
    public class Ini
    {
        ...
        public static string Filename = "config.ini";//配置文件路径
        ...
        public static string Read(string Section, string Key)
        {
            ...
            int i = GetPrivateProfileString(Section, Key, "null", temp, 255, System.AppDomain.CurrentDomain.BaseDirectory + Filename);
